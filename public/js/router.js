...
WF.router = (function () {
  const routes = {
    ...
    '/admin/social/accounts': 'adminSocialAccounts',
    '/admin/social/auto': 'adminSocialAuto',
    '/admin/social/compose': 'adminSocialCompose',
    '/admin/social/queue': 'adminSocialQueue',
    '/admin/social/logs': 'adminSocialLogs',
